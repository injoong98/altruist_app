...
class Altruists extends CB_Controller
{
	...
	public function index()
	{
		...
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_member_Altruists_index';
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_member_Altruists_write';
		$this->load->event($eventname);
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_member_Altruists_socialinfo';
		$this->load->event($eventname);
	...
	public function excel()
	{
		...
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_member_Altruists_excel';
		$this->load->event($eventname);
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_member_Altruists_listdelete';
		$this->load->event($eventname);
