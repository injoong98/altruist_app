...
class Mypage extends React.Component{
    ...
    render(){
        return(
          <SafeAreaView>
              <View style={{flexDirection:'row',margin:35,borderWidth:1}}>
                <View style={{height:95,width:95,borderWidth:1,marginVertical:20,marginLeft:30}}>
                  <Text>이미지</Text>
                </View>
                <View style={{borderWidth:1,marginLeft:16,marginTop:13,marginBottom:24,justifyContent:'space-between'}}>
                  <View style={{borderWidth:1,padding:8,flexDirection:'row'}}>
                    <View style={{}}>
                      <Text category='p2'style={{color:'#A897C2',borderWidth:1,fontSize:10,textAlignVertical:'bottom'}}>point{`\n`}score</Text>
                    </View>
                    <View style={{borderWidth:1, marginVertical:3,marginLeft:4,borderColor:'#F0F0F0'}}>
                    </View>
                    <View style={{marginLeft:10}}>
                      <Text style={{fontSize:10,lineHeight:13,color:'#63579D'}}>누적 000{`\n`}사용 000</Text>
                    </View>
                  </View>  
                  <View style={{borderWidth:1,marginTop:15,display:'flex',flexDirection:'row', alignItems:'flex-end'}}>
                ...
                <TouchableOpacity onPress={()=>{alert('more')}} style={{position:'absolute',borderWidth:1 }}>
                  <MoreSvg height={19} width={19}/>
                </TouchableOpacity > 
              </View>
              <View style={{borderWidth:1, marginHorizontal:40}}>
              ...
              <View style={{borderWidth:1, marginHorizontal:40}}>
                <View style={{flexDirection:'row',alignItems:'center',marginBottom:23}}>
                  <View style={{borderWidth:1,transform: [{ rotate: "25.69deg" }]}}>
