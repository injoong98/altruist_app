...
class Mypage extends React.Component {
  ...
  sessionChk = () => {
    axios
      .get('http://dev.unyict.org/api/login/session_check')
      .then((res) => {
        ...
        <ScrollView style={{flex: 1, backgroundColor: '#ffffff'}}>
          <View
            ...
            <View
              ...
              <View
                ...
                <Text category="h2" style={{fontSize: 24, color: '#63579D'}}>
                  {mem_nickname}
                </Text>
                <View
                  style={{
              ...
              <View style={{marginVertical: 10}}>
                <Text
                  style={{fontSize: 9, maxHeight: '100%'}}
                  numberOfLines={2}>
                  {' '}
                  {mem_profile_content}{' '}
                </Text>
              ...
              <TouchableOpacity
                ...
                onPress={() => this.props.navigation.navigate('MyPoint')}>
                <View style={{}}>
                  <Text
                    category="p2"
                    style={{
                ...
                <View style={{marginLeft: 10}}>
                  <Text
                    style={{fontSize: 10, lineHeight: 13, color: '#63579D'}}>
                    누적 {mem_point}
                    {`\n`}사용 {mem_point}
                  </Text>
                </View>
          ...
          <View style={{marginHorizontal: 40, marginBottom: 20}}>
            <View
              ...
              <Text category="h2" style={styles.menuTitle}>
                나의 활동
              </Text>
            </View>
            <View>
              ...
              <TouchableOpacity
                style={styles.menuContainer}
                onPress={() => {
                  navigate('MyList', {type: 'like_post'});
                }}>
          ...
          <View style={{marginHorizontal: 40, marginBottom: 20}}>
            ...
            <View>
              <TouchableOpacity
                style={styles.menuContainer}
                onPress={() =>
                  navigate('MyProfEdit', {mem_info: this.state.mem_info})
                }>
