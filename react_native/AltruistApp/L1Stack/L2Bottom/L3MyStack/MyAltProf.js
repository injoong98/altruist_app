...
class MyAltProf extends React.Component{
    ...
    const {isLoading,mem_info,radio,radioSelectedIndex,spinnerModalVisible,filterModalVisible,actSelected,alt_content,alt_aboutme,arrayForLoop,acv_open,acv_type,acv_file1,acv_year,acv_content,acv_final,selectedIndex,category,alt_photo} = this.state;
        return(
