...
class AlbaScreen extends React.Component {
  ...
  getPostList = async() =>{
    await axios.get(`https://dev.unyict.org/api/board_post/lists/b-a-3?page=${this.state.current_page}`)
    .then((response)=>{
  ...
  getPostFirst = async() => {
    await axios.get('https://dev.unyict.org/api/board_post/lists/b-a-3')
    .then((response)=>{
        this.setState({
