...
<link rel="stylesheet" type="text/css" href="<?php echo element('layout_skin_url', $layout); ?>/css/trex.css" />
...
<script type="text/javascript" src="<?php echo base_url('assets/js/trex.js'); ?>"></script>
