...
<script src="https://apis.google.com/js/platform.js" async defer></script>
    ...
    */
    ...
    this.currentSpeed += this.config.ACCELERATION;
      ...
      //alert(this.currentSpeed * deltaTime / this.msPerFrame);
    this.gameOver();
    }
    ...
    */
    ...
    console.info('your score',this.distanceMeter.setHighScore(Math.ceil(this.distanceRan))); 
    ...
    */
    ...
    console.info('highScoreStr',highScoreStr);
    },
    /**
